module RunoffMod
 ...
 ! Modification: add fluxes for  domestic (dom), livestock (liv), thermoelectric (elec), manufacturing (mfc) and mining (min) water usage,  withdrawal (withd) and for return flow (rf) 
 !-----------------------------------------------------------------------
 !BOP
 !
 ! !MODULE: RunoffMod
 ...
 ! !PUBLIC TYPES:
   ...
   type runoff_flow
      ...
      real(r8), pointer :: qdom_withd(:)  !domestic withdrawal
      real(r8), pointer :: qdom_rf(:)  !domestic return flow
      real(r8), pointer :: qliv_withd(:)  !livestock withdrawal
      real(r8), pointer :: qliv_rf(:)  !livestock return flow
      real(r8), pointer :: qelec_withd(:)  !thermoelectric withdrawal
      real(r8), pointer :: qelec_rf(:)  !thermoelectric return flow
      real(r8), pointer :: qmfc_withd(:)  !manufactured withdrawal
      real(r8), pointer :: qmfc_rf(:)  !manufactured return flow
