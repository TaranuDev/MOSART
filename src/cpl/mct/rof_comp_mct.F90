module rof_comp_mct
   ...
   !----------------------------------------------------------------------------
   !Modification: add indices for  domestic (dom), livestock (liv), thermoelectric (elec), manufacturing (mfc) and mining (min) water usage,  withdrawal (withd) and for return flow (rf).
